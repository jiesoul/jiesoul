...
(def css-list-table-thead-tr-th "px-1 py-1 border-gray-500 bg-gray-50 text-base leading-4 
...
(def css-list-table-tbody-tr-td "px-1 py-1 whitespace-no-wrap border-gray-200")
